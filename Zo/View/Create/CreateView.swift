...
/** The Create Page that the user will see when clicking to create a shortcut **/
    ...
    var body: some View {
        NavigationView{
            ZStack{
                ...
                VStack{
                    /** Buttons that show the specified shortcut of choice (UI look of shortcut buttons) **/
                    HStack{
                        Button {
                           showTextSnip = true
                        } label: {
...
/** The sizing and conformalities of the button in both dark and light mode in the form of a button **/
...
/** Color and UI of create buttons  **/
