...
struct CreateTextSnip: View {
        ...
        ZStack{
            ...
            VStack{
                ...
                ZStack{
                    ...
                    HStack{
                        // Adds the placeholder text, but is not at the top of the text box
                        //TextField("Create Text Shortcut...", text: $content)
                ...
                /** The contents of the user-created shortcut **/
                Button {
    ...
    /** Function to update the content of the any shortcut with user content. The use of JSON Encoder is to parse into JSON data for easier data model usage and storing user data **/
    func update() {
        for snip in snips {
    ...
    /** Function to update the content of the text shortcut with user content. The use of JSON Encoder is to parse into JSON data for easier data model usage and storing user data **/
    func updateDefaults() {
