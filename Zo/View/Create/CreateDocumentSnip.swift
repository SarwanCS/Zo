...
struct CreateDocumentSnip: View {
    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                Spacer()
                /** When the user taps the "Upload Document" button, then, the user would be able to import the document into the shortcut **/
                Button {
                    isImporting = true
                } label: {
    ...
    /** Function to update the content of the document shortcut with user content. The use of JSON Encoder is to parse into JSON data for easier data model usage and storing user data **/
    func updateDefaults() {
...
/** Textbox of the name of the shortcut **/
