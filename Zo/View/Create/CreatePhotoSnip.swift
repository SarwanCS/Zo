...
struct CreatePhotoSnip: View {
    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                Spacer()
                /** When the user taps the "Upload Photo" button, then, the user would be able to import the photo into the shortcut **/
                Button {
        ...
        /** Converts the image selected into a suitable size for usage **/
    ...
    /** Function to update the content of the photo shortcut with user content. The use of JSON Encoder is to parse into JSON data for easier data model usage and storing user data **/
    func updateDefaults() {
