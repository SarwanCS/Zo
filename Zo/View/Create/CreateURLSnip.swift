...
struct CreateURLSnip: View {
    ...
    /** Function to update the content of the URL shortcut with user content. The use of JSON Encoder is to parse into JSON data for easier data model usage and storing user data **/
    func updateDefaults() {
